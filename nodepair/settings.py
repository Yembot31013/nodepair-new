"""
Django settings for nodepair project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', default='django-insecure-y26tl+5_d!@_8mc1(7y^159xqyd5dz^w0^w7)znntzp4az#wx(')
...
# WSGI_APPLICATION = 'nodepair.wsgi.application'
ASGI_APPLICATION = 'nodepair.asgi.application'
